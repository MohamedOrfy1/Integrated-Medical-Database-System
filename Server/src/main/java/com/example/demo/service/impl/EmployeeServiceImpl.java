...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public boolean assignDocToPatient(String doctorID, String patientID){
        ...
        @Override
        public String getEmpID(String username,String pass){
            Optional<Employee> e = employeeRepository.findByUsernameAndPassword(username,pass);
            return e.map(Employee::getEmployeeId).orElse(null);
